defmodule TankTurnTacticsWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use TankTurnTacticsWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = TankTurnTactics.PlayersFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = TankTurnTactics.Players.generate_player_session_token(player)
