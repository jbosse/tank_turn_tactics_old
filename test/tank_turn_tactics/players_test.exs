defmodule TankTurnTactics.PlayersTest do
  ...
  describe "apply_player_email/3" do
    ...
    test "validates email uniqueness", %{player: player} do
      ...
      {:error, changeset} =
        Players.apply_player_email(player, valid_player_password(), %{email: email})
