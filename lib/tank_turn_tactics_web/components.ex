defmodule TankTurnTacticsWeb.Components do
  @moduledoc """
  ...
  import TankTurnTacticsWeb.Gettext, warn: false
  ...
  ## Examples
      ...
      <.simple_form :let={f} for={:player} phx-change="validate" phx-submit="save">
  ...
  ## Examples
      ...
      <.table rows={@players}>
        <:col :let={player} label="id"><%= player.id %></:col>
        <:col :let={player} label="username"><%= player.username %></:col>
      </.table>
  """
  attr :id, :string, required: true
  ...
  slot :action, doc: "the slot for showing player actions in the last table column"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TankTurnTacticsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TankTurnTacticsWeb.Gettext, "errors", msg, opts)
    end
  end
